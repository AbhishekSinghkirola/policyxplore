...
if (isset($_POST['submit'])) {
    ...
    mysqli_query($con, "insert into faq_page(faqp_question,faqp_solution,faq_category) values('$faqp_question','$faqp_solution','$faq_category') ") or die("Insert Query Failed!!");
            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" name="faqp_question" required />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea id="basic-default-message" class="form-control"  aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-message2" name="faqp_solution" required></textarea>
                        </div>
                    </div>
